import { SimpleGCallback } from './geeInterfaces';
export class GEERenderLoop {
  ...
  static create(functionLoop: SimpleGCallback<number>, framerate: number): GEERenderLoop {
    return new GEERenderLoop(functionLoop, framerate);
  }
}
